...
export default function BlockchainAnimation() {
    ...
    return (
        <div className="relative w-full h-80 overflow-hidden border-y-4 border-white/10 bg-black/40 backdrop-blur-sm my-10 flex flex-col justify-center">
            ...
            <div className="relative w-full flex items-center justify-between px-10 md:px-32">
                {/* EVM Node */}
                <div className="flex flex-col items-center z-10 group cursor-pointer">
                    <motion.div
                        animate={{ y: [0, -10, 0] }}
                        transition={{ repeat: Infinity, duration: 4, ease: "easeInOut" }}
                        className="w-24 h-24 md:w-32 md:h-32 bg-primary/20 border-4 border-primary shadow-[0_0_20px_rgba(124,58,237,0.3)] flex items-center justify-center relative backdrop-blur-md group-hover:shadow-[0_0_40px_rgba(124,58,237,0.6)] transition-all rounded-xl"
                    >
                ...
                <div className="flex flex-col items-center z-10 group cursor-pointer">
                    <motion.div
                        ...
                        className="w-24 h-24 md:w-32 md:h-32 bg-secondary/20 border-4 border-secondary shadow-[0_0_20px_rgba(0,240,255,0.3)] flex items-center justify-center relative backdrop-blur-md group-hover:shadow-[0_0_40px_rgba(0,240,255,0.6)] transition-all rounded-xl"
                    >
                        <div className="relative w-24 h-24 md:w-32 md:h-32">
                            <Image
            ...
            <div className="absolute bottom-4 right-8 text-xs text-gray-500 font-mono flex items-center gap-2">
